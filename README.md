...
running command...
$ avwx (--version)
avweather-cli/0.5.10 darwin-arm64 node-v20.10.0
$ avwx --help [COMMAND]
USAGE
  $ avwx COMMAND
...
...
_See code: [src/commands/metar.ts](https://github.com/davidfekke/avweather-cli/blob/v0.5.10/src/commands/metar.ts)_
...
_See code: [src/commands/taf.ts](https://github.com/davidfekke/avweather-cli/blob/v0.5.10/src/commands/taf.ts)_
<!-- commandsstop -->
