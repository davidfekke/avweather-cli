...
avweather-cli/0.3.0 darwin-x64 node-v16.13.1
$ avwx --help [COMMAND]
USAGE
  $ avwx COMMAND
...
...
_See code: [src/commands/metar.js](https://github.com/davidfekke/avweather-cli/blob/v0.3.0/src/commands/metar.js)_
...
_See code: [src/commands/taf.js](https://github.com/davidfekke/avweather-cli/blob/v0.3.0/src/commands/taf.js)_
<!-- commandsstop -->
